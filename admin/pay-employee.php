...
$pending_ot = 0;
foreach($approved_ots as $ot) $pending_ot += $ot['amount'];
...
<main class="main-content">
    ...
    <div>
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <div>
                 ...
                 <p class="text-muted"><?= htmlspecialchars(trim($employee['first_name'] . ' ' . $employee['last_name'])) ?> - <?= htmlspecialchars($employee['pay_cycle']) ?></p>
            </div>
    ...
    <div style="display: flex; gap: 0.5rem; align-items: stretch;  flex-wrap: wrap;">
        ...
        <!-- Filters Card -->
        <div style="background: white; border: 1px solid #e2e8f0; padding: 0.5rem 0.75rem; border-radius: 10px; flex: 2; min-width: 300px; display: flex; flex-direction: column; justify-content: center;">
            <form method="GET" style="display: flex; align-items: center; gap: 0.5rem;">
                <input type="hidden" name="id" value="<?= $id ?>">
                <div style="display: flex; flex-direction: column; gap: 1px; flex: 1;">
                    <span style="font-size: 0.6rem; color: #94a3b8; font-weight: 700; text-transform: uppercase;">From</span>
                    <input type="date" name="from_date" value="<?= $from_date ?>" style="border: 1px solid #e2e8f0; border-radius: 4px; padding: 2px 6px; font-size: 0.8rem; outline: none; width: 100%;">
                </div>
                <div style="display: flex; flex-direction: column; gap: 1px; flex: 1;">
                    <span style="font-size: 0.6rem; color: #94a3b8; font-weight: 700; text-transform: uppercase;">To</span>
                    <input type="date" name="to_date" value="<?= $to_date ?>" style="border: 1px solid #e2e8f0; border-radius: 4px; padding: 2px 6px; font-size: 0.8rem; outline: none; width: 100%;">
                </div>
                <button type="submit" style="background: #4338ca; color: white; border: none; border-radius: 4px; padding: 10px 8px; cursor: pointer; display: flex; align-items: center; justify-content: center;" title="Update">
        ...
        <!-- Attendance Card -->
        <div style="background: white; border: 1px solid #e2e8f0; padding: 0.5rem 0.75rem; border-radius: 10px; border-left: 3px solid #4338ca; flex: 1; min-width: 140px; display: flex; flex-direction: column; justify-content: center;">
            <div style="font-size: 0.6rem; color: #64748b; font-weight: 700; text-transform: uppercase; margin-bottom: 2px;">Attendance</div>
        ...
        <!-- Overtime Card -->
        <div style="background: white; border: 1px solid #e2e8f0; padding: 0.5rem 0.75rem; border-radius: 10px; border-left: 3px solid #059669; flex: 1; min-width: 120px; display: flex; flex-direction: column; justify-content: center;">
            <div style="font-size: 0.6rem; color: #64748b; font-weight: 700; text-transform: uppercase; margin-bottom: 2px;">Overtime</div>
            <div style="font-size: 1rem; font-weight: 800; color: #1e293b;">₹ <?= number_format($pending_ot, 0) ?></div>
        </div>

        <!-- Advance Card -->
        <div style="background: white; border: 1px solid #e2e8f0; padding: 0.5rem 0.75rem; border-radius: 10px; border-left: 3px solid #ef4444; flex: 1; min-width: 120px; display: flex; flex-direction: column; justify-content: center;">
            <div style="font-size: 0.6rem; color: #64748b; font-weight: 700; text-transform: uppercase; margin-bottom: 2px;">Advance</div>
            <div style="font-size: 1rem; font-weight: 800; color: #ef4444;">₹ <?= number_format($outstanding_advance, 0) ?></div>
        </div>
    ...
    <form method="POST" style="display: grid; grid-template-columns: 2fr 1fr; gap: 1rem;">
        ...
        <div style="display: flex; flex-direction: column; gap: 1rem;">
            ...
            <div style="background: white; border: 1px solid #e2e8f0; padding: 1.5rem; border-radius: 8px;">
                <h3 style="font-size: 1.1rem; font-weight: 600; color: #1e293b; margin-bottom: 1rem;">Salary Breakdown</h3>
                
                <div style="margin-bottom: 1.5rem;">
                    <div style="display: flex; justify-content: space-between; margin-bottom: 0.75rem; color: #64748b; font-size: 0.95rem;">
                        <span>Attendance Salary (Calculated)</span>
                        <span style="font-weight: 600; color: #1e293b;">₹ <?= number_format($attendance_pay, 2) ?></span>
                    </div>
                    <div style="font-size: 0.7rem; color: #94a3b8;">Based on <?= $present_days ?> full days and <?= $half_days ?> half days.</div>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 1rem;">
                    ...
                    <div style="position: relative;">
                        ...
                        <input type="number" step="0.01" name="overtime" id="overtime" class="form-control" style="padding-left: 2rem;" placeholder="0.00" value="<?= $pending_ot > 0 ? $pending_ot : '' ?>" oninput="calculateNet()">
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 1rem;">
                    ...
                    <div style="position: relative;">
                         <span style="position: absolute; left: 1rem; top: 50%; transform: translateY(-50%); color: #64748b;">₹</span>
                        <input type="number" step="0.01" name="bonus" id="bonus" class="form-control" style="padding-left: 2rem;" placeholder="0.00" oninput="calculateNet()">
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div class="form-group">
                        ...
                        <div style="position: relative;">
                            <span style="position: absolute; left: 1rem; top: 50%; transform: translateY(-50%); color: #64748b;">₹</span>
                            <input type="number" step="0.01" name="lates" id="lates" class="form-control" style="padding-left: 2rem;" placeholder="0.00" oninput="calculateNet()">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span style="font-size: 0.85rem; color: #dc2626; font-weight: 700;">Due: ₹<?= number_format($outstanding_advance, 2) ?></span>
                        </div>
                        <div style="position: relative;">
                            <span style="position: absolute; left: 1rem; top: 50%; transform: translateY(-50%); color: #64748b;">₹</span>
                            <input type="number" step="0.01" name="advance_repay" id="advance_repay" class="form-control" style="padding-left: 2rem;" placeholder="0.00" oninput="calculateNet()">
                        </div>
                    </div>
                </div>
             ...
             <div style="background: white; border: 1px solid #e2e8f0; padding: 1.5rem; border-radius: 8px;">
                <h3 style="font-size: 1.1rem; font-weight: 600; color: #1e293b; margin-bottom: 1rem;">Payment Method</h3>
        ...
        <div style="display: flex; flex-direction: column; gap: 1rem;">
             ...
             <div style="background: white; border: 1px solid #e2e8f0; padding: 1.5rem; border-radius: 8px; border-top: 4px solid #10b981;">
                ...
                <div style="display: flex; justify-content: space-between; margin-bottom: 0.5rem; color: #64748b;">
                    ...
                    <span id="gross_total">₹ <?= number_format($employee['base_salary'], 2) ?></span>
                </div>
                 ...
                 <div style="background: #f0fdf4; padding: 1.5rem; border-radius: 8px; text-align: center; margin-bottom: 1.5rem; border: 1px solid #bbf7d0;">
                     <div style="font-size: 0.9rem; color: #166534; margin-bottom: 0.5rem;">Net Payable Amount</div>
                     <div id="net_payable" style="font-size: 2rem; font-weight: 700; color: #15803d;">₹ <?= number_format($employee['base_salary'], 2) ?></div>
                 </div>

                 <div class="form-group" style="margin-bottom: 1.5rem;">
                     <label class="form-label" style="font-size: 0.95rem; color: #1e293b; margin-bottom: 0.5rem; display: block;">Amount Paying Now</label>
                     <div style="position: relative;">
                         <span style="position: absolute; left: 1rem; top: 50%; transform: translateY(-50%); color: #64748b; font-weight: bold;">₹</span>
                         <input type="number" step="0.01" name="paying_now" id="paying_now" class="form-control" style="padding-left: 2rem; font-size: 1.25rem; font-weight: 700; color: #1e293b;" value="<?= $employee['base_salary'] ?>">
                     </div>
                 </div>

                 <button type="submit" class="btn btn-primary w-full" style="justify-content: center; width: 100%; margin-bottom: 1rem; padding: 1rem; font-size: 1rem;">
                     Confirm Payment <i class="ri-arrow-right-line" style="margin-left: 0.5rem;"></i>
                 </button>
                 <button type="button" onclick="history.back()" class="btn w-full" style="justify-content: center; width: 100%; background: #f8fafc; border: 1px solid #e2e8f0; color: #64748b;">Cancel</button>
